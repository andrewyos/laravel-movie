...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                <img src="{{'https://image.tmdb.org/t/p/w500/'.$movie['poster_path']}}" alt="parasite" class="w-70 md:w-96">
                <div class="md:ml-24">
                    ...
                    <div x-data="{isOpen:false}">
                        ...
                        <div class="mt-12">
                            <button
                            @click="isOpen = true"
                                href="https://www.youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" id="trailer" class="flex inline-flex items-center text-gray-900 rounded font-semibold px-5 py-4"
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16">
                @foreach ($movie['credits']['cast'] as $cast)
                    @if ($loop->index<10)
                        <div class="mt-8">
                            <a href="">
                                <img src="{{'https://image.tmdb.org/t/p/w500/'.$cast['profile_path']}}" alt="actor1" class="hover:opacity-70 transitition ease-in-out duration-150">
                            </a>
                            <div class="mt-2">
                                <a href="#" class="text-xl mt-2 hover:text-gray-300">{{$cast['original_name']}}</a>
                            </div>
                            <div class="mt-1">
                                <a href="#" class="text-lg mt-1 text-gray-300">({{$cast['character']}})</a>
                            </div>
                        </div>
                    @endif
                @endforeach
